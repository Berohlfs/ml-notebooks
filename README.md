...
If you wish to execute the notebooks on your machine, you need to setup your Python environment:

1. Install Python on your machine using [uv](https://docs.astral.sh/uv/getting-started/installation/).
